...
echo "- tests/coverage_report.md: Detailed coverage report with recommendations"
echo "- tests/analyze_coverage.lua: Static analysis script"
echo "- tests/generate_coverage_report.lua: Automated report generator"
echo ""
echo "Summary:"
echo "- Total tests: 44"
...
echo ""
echo "View detailed report: cat tests/coverage_report.md"
